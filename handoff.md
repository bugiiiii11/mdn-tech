...
**Session 30 polished the SK landing** -- new hero motto "Expandujte svoj biznis online." (cosmic/expansion theme), full vykanie across /sk, leaner hero (mobile blackhole now matches the EN home), and content/footer cleanups (removed for-whom note + value-ladder pricing note; Royal Stroje tag -> Command Center; footer socials hidden on /sk). One open micro-decision: whether to hide footer socials globally (currently /sk-only) -- see Session 30 note 6.
