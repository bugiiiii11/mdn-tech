...
9. **Repo diff this session**: this documentation + the `railway.ts` query fix. `.env.local` gained `CRON_SECRET`, `TELEGRAM_BOT_TOKEN`, `TELEGRAM_ALERT_CHAT_ID`, `RESEND_API_KEY`, `ALERT_EMAIL_TO` (all gitignored).
