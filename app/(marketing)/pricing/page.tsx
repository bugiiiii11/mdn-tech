...
export const metadata = {
  title: 'ChatKit Pricing — M.D.N Tech',
  description:
    'Free trial of 50 messages per chatbot, then $19 for 1,000 credits. No subscription, no expiry, pay only when you grow.',
}

export default function PricingPage() {
  return (
    <main className="min-h-screen w-full pt-24 pb-20 px-4 md:px-8">
      <section className="max-w-5xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-14">
          <p className="text-xs text-cyan-400/80 font-mono uppercase tracking-wider mb-3">
            ChatKit pricing
          </p>
          <h1 className="text-4xl md:text-5xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-400 leading-tight">
        ...
        <div className="grid md:grid-cols-2 gap-5 max-w-4xl mx-auto">
          ...
          <div className="bg-[#0d0d20]/80 border border-white/[0.08] rounded-2xl p-7 space-y-5 backdrop-blur-sm">
            ...
            <Link
              href="/portal/signup"
              className="block w-full text-center text-sm py-3 rounded-xl border border-white/15 text-gray-200 hover:border-white/30 hover:text-white transition-colors"
            >
              Start free
            </Link>
          </div>
          ...
          <div className="bg-[#0d0d20]/80 border border-purple-400/30 rounded-2xl p-7 space-y-5 backdrop-blur-sm relative overflow-hidden">
            ...
            <div className="relative space-y-5">
              ...
              <Link
                href="/portal/signup"
                className="block w-full text-center text-sm py-3 rounded-xl button-primary text-white"
              >
                Get started
              </Link>
            </div>
        ...
        <div className="mt-14 max-w-3xl mx-auto bg-[#0d0d20]/60 border border-white/[0.06] rounded-2xl p-6 backdrop-blur-sm">
        ...
        <div className="mt-12 max-w-3xl mx-auto space-y-4">
          <h2 className="text-xl font-semibold text-white text-center">Common questions</h2>
