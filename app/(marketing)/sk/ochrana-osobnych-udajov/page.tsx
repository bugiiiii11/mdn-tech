...
//
// No hreflang pair yet: the English page is a client component and cannot
// export metadata, so it cannot declare the reciprocal alternate, and
// one-directional hreflang is ignored. Flagged for the SEO re-audit.
