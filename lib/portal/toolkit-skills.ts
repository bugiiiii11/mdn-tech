...
export const toolkitSkills: ToolkitSkill[] = [
  ...
  },
  {
    ...
    verified: true,
    installationUrl: 'https://github.com/anthropics/claude-code/skills/ui-ux-pro-max',
    details:
  ...
  },
  {
    ...
    author: 'Anthropic Skills',
    verified: true,
    installationUrl: 'https://github.com/anthropics/claude-code/skills/seo-audit',
    details:
  ...
  },
  {
    ...
    author: 'Anthropic Skills',
    verified: true,
    installationUrl: 'https://github.com/anthropics/claude-code/skills/frontend-design',
    details:
  ...
  },
  {
    ...
    name: 'Simplify',
    category: 'testing',
    description: 'Code review for quality & efficiency. Identify reuse, refactoring opportunities.',
    author: 'Anthropic Skills',
    verified: true,
    details:
      'Automated code review. Scans changed code for unused logic, inefficient patterns, and refactoring opportunities. Improves code quality and maintainability.',
    useCases: ['Code cleanup', 'Refactoring guidance', 'Quality assurance'],
  },
  {
    id: 'claude-api',
    name: 'Claude API',
    ...
    author: 'Anthropic Skills',
    verified: true,
    installationUrl: 'https://github.com/anthropics/claude-code/skills/claude-api',
    details:
