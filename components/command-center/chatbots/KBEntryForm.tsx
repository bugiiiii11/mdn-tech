...
export function KBEntryForm({ chatbotId, entry }: { chatbotId: string; entry?: any }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    router.push(`/command-center/chatbots/${chatbotId}`)
    router.refresh()
  }
...
## Example
This section can contain product details, FAQs, policies, tone guidelines, etc.
